...
Future<ApiResponse> _register(username, password) async {
  try{

    /*
     * Request Url
     */
    var uri = Uri.parse(host + '/registration');
    /*
     * Request Header
     */
...
Future<ApiResponse> signUp(username, password) async{
  return await
  _register(username, password).then((value) { return value; })
                            .catchError((error){
